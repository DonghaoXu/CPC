...
r(1) = text(0.5, -0.2, A, 'horizontalalignment', 'center');
r(2) = text(1.2-0.45*sin(deg2rad(30)), 0.5, B, 'rotation', -60, 'horizontalalignment', 'center');
r(3) = text(-0.2+0.45*sin(deg2rad(30)), 0.5, C, 'rotation', 60, 'horizontalalignment', 'center');
